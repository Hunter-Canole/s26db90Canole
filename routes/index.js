...
router.get('/', function (req, res) {
    res.render('index', { title: 'Jewelry App', user : req.user });
});
router.get('/register', function(req, res) {
    res.render('register', { title: 'Jewelry App Registration'});
});
...
router.get('/login', function(req, res) {
    res.render('login', { title: 'Jewelry App Login', user : req.user });
});
